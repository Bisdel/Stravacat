    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="profile.html">Mon profil</a>
                </li>
    ...
    <div class="container text-center">
                    ...
                    <div class="card-body">
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" fill="currentColor" class="bi bi-search text-primary"
                                    viewBox="0 0 16 16">
                                    <path
                ...
                <div class="card" style="height: 260px;margin-top: 20px;">
                    ...
                    <div class="card-body">
                        <div class="row mb-3 justify-content-around">
                            <img class="border border-secondary-subtle border-1 rounded-4" src="assets\images\profile_picture_index_2.png" style="height: 100px; width: 100px; object-fit: cover;"
                                alt="...">
        ...
        <div class="col">
            <div class="card" style="height: 400px;">
                <div class="card-header">
                    <strong>Mon fil d'actu </strong><a href=""><svg xmlns="http://www.w3.org/2000/svg" width="20"
                            height="20" fill="currentColor" class="bi bi-arrow-clockwise">
                ...
                <div class="card-body" style="height: 320px; overflow-y: scroll;">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam amet quae neque maxime
                                voluptatum explicabo dignissimos beatae dicta repudiandae aspernatur ducimus, at
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam amet quae neque
                                maxime voluptatum explicabo dignissimos beatae dicta repudiandae aspernatur
                                ducimus, at culpa ex voluptatibus dolorum error ut exercitationem deserunt.</p>
                        </div>
                    </div>
                    <div class="card mb-3">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam amet quae
                                neque maxime voluptatum explicabo dignissimos beatae dicta repudiandae
                                aspernatur ducimus, at culpa ex voluptatibus dolorum error ut exercitationem
                                deserunt.</p>
                        </div>
                    </div>
                </div>
